...
const Tooltip: React.FC<Props> = ({tooltipText}) => {
  ...
  return (
    <div>
      ...
      <div id="tooltip-default" role="tooltip" className="absolute z-50 inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700">
        {tooltipText}
