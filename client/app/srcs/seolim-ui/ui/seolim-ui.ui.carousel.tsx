...
const UiCarousel: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <UiBox>
        <Title text="기본 사용법" />
        <Description text="기본적인 캐러셀 형태입니다." />
        <Carousel>
      ...
      <UiBox>
        <Title text="변형" />
        <Description text="variant 속성으로 캐러셀의 스타일을 변경할 수 있습니다." />
      ...
      <UiBox>
        <Title text="버튼 표시" />
        <Description text="showButtons 속성으로 이전/다음 버튼을 제어할 수 있습니다." />
      ...
      <UiBox>
        <Title text="자동 재생" />
        <Description text="autoPlay와 autoPlayInterval 속성으로 자동 재생을 설정할 수 있습니다." />
