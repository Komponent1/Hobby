...
const UiSelect: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <UiBox>
        <Title text="기본 사용법" />
        <Description text="가장 기본적인 셀렉트 사용 예시입니다." />
      ...
      <UiBox>
        <Title text="variant" />
        <Description text="variant 속성으로 셀렉트의 스타일을 변경할 수 있습니다." />
      ...
      <UiBox>
        <Title text="size" />
        <Description text="size 속성으로 셀렉트의 크기를 조절할 수 있습니다." />
        <div className="flex gap-6 mt-4 flex-wrap items-center">
          <div>
      ...
      <UiBox>
        <Title text="disabled" />
        <Description text="disabled 속성으로 셀렉트를 비활성화할 수 있습니다." />
        <div className="flex gap-6 mt-4 flex-wrap items-center">
      ...
      <UiBox>
        <Title text="실전 예시 조합" />
        <Description text="다양한 속성을 조합한 실제 사용 예시입니다." />
