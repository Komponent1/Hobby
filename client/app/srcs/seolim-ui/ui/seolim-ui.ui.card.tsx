...
const UiCard: React.FC = () => (
  <div className="space-y-6">
    ...
    <UiBox>
      <Title text="기본 사용법" />
      <Description text="기본적인 콘텐츠 카드입니다." />
    ...
    <UiBox>
      <Title text="타입" />
      <Description text="type 속성으로 카드의 레이아웃을 변경할 수 있습니다." />
          ...
          <Card
            ...
            footer={(
              <div className="p-4 bg-gray-100 text-center">
                <Button type="button" content="액션" size="sm" onClick={() => {}} />
              </div>
            )}
          >
            <div className="p-4">
    ...
    <UiBox>
      <Title text="크기" />
      <Description text="size 속성으로 카드의 크기를 조절할 수 있습니다." />
    ...
    <UiBox>
      <Title text="호버 효과" />
      <Description text="hoverType 속성으로 마우스 호버 시 효과를 설정할 수 있습니다." />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <div>
    ...
    <UiBox>
      <Title text="자동 패딩" />
      <Description text="autoPadding 속성으로 콘텐츠 영역에 자동으로 패딩을 적용할 수 있습니다." />
            ...
            <Card
              ...
              footer={(
                <div className="p-4 flex justify-between items-center">
                  ...
                  <Button type="button" content="구매" size="sm" variant="solid" onClick={() => {}} />
                </div>
              )}
            >
              <div className="p-4">
            ...
            <Card
              ...
              footer={(
                <div className="p-4 border-t">
                  <Button type="button" content="더 읽기 →" variant="text" size="sm" onClick={() => {}} />
                </div>
              )}
            >
              <div className="p-4">
        ...
        <div>
          ...
          >
            <div className="p-8 text-white">
              ...
              <Button type="button" content="자세히 보기" variant="solid" onClick={() => {}} />
            </div>
          </Card>
        </div>
      </div>
        ...
        <Card
          ...
          footer={(
            <div className="p-4 flex gap-2">
              <Button type="button" content="좋아요" variant="outline" size="sm" onClick={() => {}} />
              <Button type="button" content="공유" variant="solid" size="sm" onClick={() => {}} />
            </div>
          )}
        >
          <div className="p-6">
          ...
          <Card
            ...
            footer={(
              <div className="p-4 bg-gradient-to-r from-purple-500 to-pink-500 flex justify-center">
                <Button type="button" content="시작하기" variant="solid" color="#ffffff" textColor="#a855f7" onClick={() => {}} />
              </div>
            )}
          >
            <div className="p-6">
