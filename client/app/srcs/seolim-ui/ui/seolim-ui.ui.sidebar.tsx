...
const UiSidebar: React.FC = () => (
  <div className="space-y-6">
    ...
    <UiBox>
      <Title text="variant 예제" />
      <Description text="variant prop에 따라 사이드바 동작이 달라집니다." />
    ...
    <UiBox>
      <Title text="position 예제" />
      <Description text="position prop에 따라 사이드바 위치가 달라집니다." />
      <div className="relative h-96 flex gap-8 mt-4 flex-wrap">
        <div className="relative flex-1 bg-gray-200 rounded-r-2xl">
    ...
    <UiBox>
      <Title text="buttonTop, buttonSize, buttonStyle" />
      <Description text="접기/펼치기 버튼의 위치, 크기('sm', 'md', 'lg'), 스타일을 지정할 수 있습니다." />
      <div className="relative h-96 flex gap-8 mt-4 flex-wrap">
    ...
    <UiBox>
      <Title text="실제 사용 예제" />
      <Description text="실제 레이아웃에서 Sidebar를 활용하는 예시입니다." />
