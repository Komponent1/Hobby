    ...
    <UiBox>
      ...
      <div className="flex justify-center p-8 mt-4">
        <Tooltip content="기본 툴팁입니다">
          <Button type="button" content="마우스를 올려보세요" onClick={() => {}} />
        </Tooltip>
      </div>
    </UiBox>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-8 mt-4">
        <div className="flex justify-center">
          <Tooltip content="위쪽 툴팁" position="top">
            <Button type="button" content="위" onClick={() => {}} />
          </Tooltip>
        </div>
        <div className="flex justify-center">
          <Tooltip content="아래쪽 툴팁" position="bottom">
            <Button type="button" content="아래" onClick={() => {}} />
          </Tooltip>
        </div>
        <div className="flex justify-center">
          <Tooltip content="왼쪽 툴팁" position="left">
            <Button type="button" content="왼쪽" onClick={() => {}} />
          </Tooltip>
        </div>
        <div className="flex justify-center">
          <Tooltip content="오른쪽 툴팁" position="right">
            <Button type="button" content="오른쪽" onClick={() => {}} />
          </Tooltip>
        </div>
      </div>
    </UiBox>
    ...
    <UiBox>
      ...
      <div className="flex gap-8 justify-center p-8 mt-4 flex-wrap">
        <Tooltip content="화살표 없음" arrow={false}>
          <Button type="button" content="화살표 없음" onClick={() => {}} />
        </Tooltip>
        <Tooltip content="화살표 있음" arrow>
          <Button type="button" content="화살표 있음" onClick={() => {}} />
        </Tooltip>
      </div>
    </UiBox>
    ...
    <UiBox>
      ...
      <div className="flex gap-6 justify-center p-8 mt-4 flex-wrap">
        <Tooltip
          ...
          arrow
        >
          <Button type="button" content="파란색" variant="solid" color="#3b82f6" textColor="#ffffff" onClick={() => {}} />
        </Tooltip>
        <Tooltip
          content="초록색 툴팁"
          ...
          arrow
        >
          <Button type="button" content="초록색" variant="solid" color="#22c55e" textColor="#ffffff" onClick={() => {}} />
        </Tooltip>
        <Tooltip
          content="빨간색 툴팁"
          ...
          arrow
        >
          <Button type="button" content="빨간색" variant="solid" color="#ef4444" textColor="#ffffff" onClick={() => {}} />
        </Tooltip>
        <Tooltip
          content="보라색 툴팁"
          ...
          arrow
        >
          <Button type="button" content="보라색" variant="solid" color="#a855f7" textColor="#ffffff" onClick={() => {}} />
        </Tooltip>
      </div>
    </UiBox>
