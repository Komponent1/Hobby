...
const UiModal: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <UiBox>
        <Title text="기본 사용법" />
        <Description text="기본적인 모달 형태입니다." />
        <div className="p-8 mt-4">
          <Button type="button" content="기본 모달 열기" onClick={() => setIsDefaultOpen(true)} />
          <Modal isOpen={isDefaultOpen} onClose={() => setIsDefaultOpen(false)}>
            <div className="p-6">
              ...
              <Button type="button" content="닫기" onClick={() => setIsDefaultOpen(false)} />
            </div>
          </Modal>
        </div>
      </UiBox>
      ...
      <UiBox>
        <Title text="변형" />
        <Description text="variant 속성으로 모달의 스타일을 변경할 수 있습니다." />
        <div className="flex gap-4 mt-4">
          <Button type="button" content="Default" onClick={() => setIsDefaultOpen(true)} />
          <Button type="button" content="Fullscreen" onClick={() => setIsFullscreenOpen(true)} />
        </div>
        <Modal isOpen={isFullscreenOpen} onClose={() => setIsFullscreenOpen(false)} variant="fullscreen">
          <div className="p-8">
            ...
            <Button type="button" content="닫기" onClick={() => setIsFullscreenOpen(false)} />
          </div>
        </Modal>
      </UiBox>
      ...
      <UiBox>
        <Title text="크기" />
        <Description text="size 속성으로 모달의 크기를 조절할 수 있습니다." />
        <div className="flex gap-4 mt-4 flex-wrap">
          <Button type="button" content="Small" size="sm" onClick={() => setIsSmallOpen(true)} />
          <Button type="button" content="Medium" size="sm" onClick={() => setIsMediumOpen(true)} />
          <Button type="button" content="Large" size="sm" onClick={() => setIsLargeOpen(true)} />
          <Button type="button" content="XL" size="sm" onClick={() => setIsXLOpen(true)} />
        </div>
        <Modal isOpen={isSmallOpen} onClose={() => setIsSmallOpen(false)} size="sm">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" size="sm" onClick={() => setIsSmallOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isMediumOpen} onClose={() => setIsMediumOpen(false)} size="md">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsMediumOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isLargeOpen} onClose={() => setIsLargeOpen(false)} size="lg">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsLargeOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isXLOpen} onClose={() => setIsXLOpen(false)} size="xl">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsXLOpen(false)} />
          </div>
        </Modal>
      </UiBox>
      ...
      <UiBox>
        <Title text="위치" />
        <Description text="position 속성으로 모달의 위치를 변경할 수 있습니다." />
        <div className="flex gap-4 mt-4">
          <Button type="button" content="Center" onClick={() => setIsCenterOpen(true)} />
          <Button type="button" content="Top" onClick={() => setIsTopOpen(true)} />
          <Button type="button" content="Bottom" onClick={() => setIsBottomOpen(true)} />
        </div>
        <Modal isOpen={isCenterOpen} onClose={() => setIsCenterOpen(false)} position="center">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsCenterOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isTopOpen} onClose={() => setIsTopOpen(false)} position="top">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsTopOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isBottomOpen} onClose={() => setIsBottomOpen(false)} position="bottom">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsBottomOpen(false)} />
          </div>
        </Modal>
      </UiBox>
      ...
      <UiBox>
        <Title text="애니메이션" />
        <Description text="animationType 속성으로 애니메이션 효과를 변경할 수 있습니다." />
        <div className="flex gap-4 mt-4">
          <Button type="button" content="Fade" onClick={() => setIsFadeOpen(true)} />
          <Button type="button" content="Slide" onClick={() => setIsSlideOpen(true)} />
          <Button type="button" content="Zoom" onClick={() => setIsZoomOpen(true)} />
        </div>
        <Modal isOpen={isFadeOpen} onClose={() => setIsFadeOpen(false)} animationType="fade">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsFadeOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isSlideOpen} onClose={() => setIsSlideOpen(false)} animationType="slide">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsSlideOpen(false)} />
          </div>
        </Modal>
        <Modal isOpen={isZoomOpen} onClose={() => setIsZoomOpen(false)} animationType="zoom">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsZoomOpen(false)} />
          </div>
        </Modal>
      </UiBox>
      ...
      <UiBox>
        <Title text="닫기 버튼 위치" />
        <Description text="closeButtonPosition 속성으로 닫기 버튼의 위치를 변경할 수 있습니다." />
        <div className="flex gap-4 mt-4 flex-wrap">
          <Button type="button" content="Top Right" size="sm" onClick={() => setIsTopRightClose(true)} />
          <Button type="button" content="Top Left" size="sm" onClick={() => setIsTopLeftClose(true)} />
          <Button type="button" content="Bottom Right" size="sm" onClick={() => setIsBottomRightClose(true)} />
          <Button type="button" content="Bottom Left" size="sm" onClick={() => setIsBottomLeftClose(true)} />
          <Button type="button" content="None" size="sm" onClick={() => setIsNoClose(true)} />
        </div>
        ...
        <Modal isOpen={isNoClose} onClose={() => setIsNoClose(false)} closeButtonPosition="none">
          <div className="p-6">
            ...
            <Button type="button" content="닫기" onClick={() => setIsNoClose(false)} />
          </div>
        </Modal>
      </UiBox>
      ...
      <UiBox>
        ...
        <div className="space-y-8 mt-4">
          <div>
            ...
            <Button type="button" content="회원가입" onClick={() => setIsFormOpen(true)} />
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 mt-6">
                    <Button type="button" content="가입하기" variant="solid" onClick={() => setIsFormOpen(false)} />
                    <Button type="button" content="취소" variant="outline" onClick={() => setIsFormOpen(false)} />
                  </div>
                </div>
              </div>
            </Modal>
          ...
          <div>
            ...
            <Button type="button" content="삭제" variant="solid" color="#ef4444" onClick={() => setIsConfirmOpen(true)} />
            <Modal isOpen={isConfirmOpen} onClose={() => setIsConfirmOpen(false)} size="sm" animationType="zoom">
              <div className="p-6 text-center">
                ...
                <div className="flex gap-2 justify-center">
                  <Button type="button" content="취소" variant="outline" onClick={() => setIsConfirmOpen(false)} />
                  <Button type="button" content="삭제" variant="solid" color="#ef4444" onClick={() => setIsConfirmOpen(false)} />
                </div>
              </div>
            </Modal>
          </div>
          ...
          <div>
            ...
            <Button type="button" content="이미지 보기" onClick={() => setIsImageOpen(true)} />
            <Modal isOpen={isImageOpen} onClose={() => setIsImageOpen(false)} size="lg" animationType="fade">
              <div className="p-6">
                ...
                <Button type="button" content="닫기" onClick={() => setIsImageOpen(false)} />
              </div>
            </Modal>
          </div>
        </div>
          ...
          <Modal isOpen={isMixOpen} onClose={() => setIsMixOpen(false)} size="lg" position="top" animationType="slide" closeButtonPosition="top-left">
            <div className="p-6">
              <p className="text-sm text-gray-600">
                size="lg", position="top", animationType="slide", closeButtonPosition="top-left&ldquo;를 조합한 모달입니다.
              </p>
            </div>
          </Modal>
        </div>
