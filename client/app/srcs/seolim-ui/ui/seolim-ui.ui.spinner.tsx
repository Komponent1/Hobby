...
const UiSpinner: React.FC = () => (
  <div className="space-y-6">
    ...
    <UiBox>
      <Title text="크기" />
      <Description text="스피너 크기는 sm, md, lg 또는 커스텀 픽셀 값으로 설정할 수 있습니다." />
    ...
    <UiBox>
      <Title text="변형" />
      <Description text="default는 시계 방향, inverted는 반시계 방향으로 회전합니다." />
      <div className="space-y-6 mt-4">
        <div>
    ...
    <UiBox>
      <Title text="색상" />
      <Description text="color prop을 사용하여 스피너의 색상을 변경할 수 있습니다." />
