...
const UiContextMenu: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <UiBox>
        <Title text="기본 사용법" />
        <Description text="영역을 우클릭하면 컨텍스트 메뉴가 표시됩니다." />
        <div
      ...
      <UiBox>
        <Title text="구분선 사용" />
        <Description text="dividerIndex 속성으로 메뉴 항목 사이에 구분선을 추가할 수 있습니다." />
        <div
          className="mt-4 p-16 border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:bg-gray-50"
      ...
      <UiBox>
        <Title text="실제 사용 예제" />
        <Description text="파일 관리 시스템과 같은 실제 시나리오에서의 컨텍스트 메뉴 사용 예제입니다." />
