...
const MainPage: React.FC = () => (
  <div className="p-8">
    ...
    <Typography element="p" size="lg" weight="regular">
      Seolim UI는 React 기반의 다양한 UI 컴포넌트를 제공합니다. 이 라이브러리를
      통해 일관된 사용자 경험을 구현할 수 있습니다.
    </Typography>
    <div className="mt-4">
      <Typography element="p" size="lg" weight="regular">
        버전:
    ...
    <div className="mt-6">
      ...
      <pre className="bg-gray-100 p-4 rounded mt-2 dark:bg-gray-800 overflow-x-scroll">
