...
export const SimpleCard: React.FC<Props> = ({
  ...
  <Card type="content" hoverType="lift" size="lg">
    <div
      onClick={onLink}
      className="flex flex-col justify-between p-6 cursor-pointer h-74"
    >
      <div>
        {icon && (
          <div className="flex justify-end">
            <div
              className={`rounded-sm w-10 h-10 flex justify-center items-center ${iconBackground}`}
            >
        ...
        <div className="mb-2">
          <Typography element="p" type="primary" size="3xl" weight="bold">
            {title}
          </Typography>
        </div>
